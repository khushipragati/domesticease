# DomesticEASE - Helper Appointment Web App

**DomesticEASE** is a full-stack web application designed to make home chores more accessible by simplifying the process of booking Helper appointments. It offers three levels of login: **User**, **Helpers**, and **Admin**, each with distinct features tailored to their roles. The app integrates **online payment gateways (Stripe and Razorpay)** to facilitate seamless and secure payments. Built using the **MERN stack** (MongoDB, Express.js, React.js, and Node.js), DomesticEASE provides an efficient, user-friendly experience for both user and Helper providers.
...
- **Helpers Login**:
  - Helpers can log in and manage appointments.
  - Dashboard displays earnings, number of User, number of appointments, and latest bookings.
...
- Features a user-friendly layout where users can:
  - **Search for Helpers** based on specialties.
  - **View top Helpers** and their profiles.
...
- Lists all available helpers.
- Users can **filter helper by specialty**.
- Clicking on a helper's profile redirects to the **Helper Appointment Page**.

## 📄 About Page

- Provides information about **DomesticEASE’s vision** and mission.
